...
const validateBannerInput = [
    ...
    body("type")
        .optional()
        .isIn(Object.values(BannerType)).withMessage(`Type must be one of: ${Object.values(BannerType).join(", ")}`),
    body("position")
        .optional()
        .isIn(Object.values(BannerPosition)).withMessage(`Position must be one of: ${Object.values(BannerPosition).join(", ")}`),
    body("startDate")
        .optional()
...
router.get("/", [
    ...
    query("type").optional().isIn(Object.values(BannerType)),
    query("position").optional().isIn(Object.values(BannerPosition)),
